...
export default function Biography() {
  ...
  return (
    <div className='flex flex-col mt-12 lg:mt-0 lg:w-1/2'>
        ...
        <div className="h-1/2 lg:max-h-[18rem] z-10 p-2 lg:overflow-auto transition ease-in hover:scale-200 hover:text-sm hover:-translate-x-48 hover:-translate-y-20 hover:border-8 hover:border-green-700 hover:bg-black hover:p-4 hover:rounded-lg duration-150"> 
            <div className="">
